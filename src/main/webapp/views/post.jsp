                                                ...
                                                <ul>
                                                    ...
                                                    <c:forEach var="userMarking" items="${userMarkings}">
                                                        <li class="marks_list_elems" data-id="${userMarking.id}">
                                                            ...
                                                            <!--<p><a href="/views/image_view.jsp" data-img="${userMarking.stringContent}" onclick="localStorage.setItem('base64Img', this.getAttribute('data-img'))" target="_blank">${userMarking.fileName}</a></p>-->
                                                            <p><a href="/${role}/courses/${course.id}/posts/${post.id}/${userMarking.fileName}?userId=${userMarking.id}" target="_blank">${userMarking.fileName}</a></p>
                                                            <c:choose>
